...
function setCorrectSliders(){var e,t,r,i;e=document.querySelector(".welcome-slider__main"),new Swiper(e,{slidesPerView:1,grabCursor:!0,autoplay:{delay:3500,disableOnInteraction:!1},pagination:{el:".welcome-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"}}),document.querySelectorAll(".action__slider").forEach((function(e){new Swiper(e,{grabCursor:!0,parallax:!0,speed:700})})),t=document.querySelector(".heroes-slider"),new Swiper(t,{slidesPerView:1,pagination:{el:".heroes-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"},breakpoints:{660:{slidesPerView:2}}}),r=document.querySelector(".reviews-slider"),i=new Swiper(r,{spaceBetween:50,slideActiveClass:"reviews-slider__slide_active",pagination:{el:".reviews-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"}}),window.matchMedia("(min-width: 880px)").matches&&i.destroy()}function setCorrectLazyLoad(){new LazyLoad({threshold:330})}function setCorrectFormPopup(){var e=document.querySelectorAll(".trigger"),t=document.querySelector(".wrapper");e.forEach((function(e){e.addEventListener("click",(function(){var r=e.dataset.popupSelector,i=document.querySelector(r),o=i.querySelector(".popup__row"),n=i.querySelector("input"),l=i.querySelector("form"),a=function r(n){n.target!==o&&27!==n.keyCode||(i.classList.remove("active"),document.removeEventListener("click",r),document.documentElement.classList.remove("unscroll"),t.inert=!1,e.focus())},c=e.closest("form");c&&"true"!==c.dataset.isValid||(document.documentElement.classList.add("unscroll"),t.inert=!0,i.classList.add("active"),l&&l.addEventListener("submit",(function(e){e.preventDefault(),i.classList.remove("active")})),n&&setTimeout((function(){n.focus()}),100),document.addEventListener("click",a),document.addEventListener("keydown",a))}))}))}function setCorrectFormValidity(){var e=document.querySelectorAll("form");e.forEach((function(e){var t=e.querySelector('[type="submit"]');e.addEventListener("submit",(function(e){e.preventDefault()})),Array.from(e.children).forEach((function(r){r.addEventListener("input",(function(t){e.dataset.isValid=!1;var i=e.reportValidity();e.dataset.isValid=i,r.focus()})),r.addEventListener("keypress",(function(r){13===r.keyCode&&(r.preventDefault(),"true"===e.dataset.isValid&&t.click())}))}))}))}function setCorrectIntlInputs(){document.querySelectorAll("input[type='tel']").forEach((function(e){window.intlTelInput(e,{initialCountry:"ru",autoPlaceholder:"aggressive",customPlaceholder:function(e,t){return"например: "+e}})}))}function setCorrectVideoPopups(){$(".video-iframe-link").magnificPopup({type:"iframe"})}document.addEventListener("DOMContentLoaded",(function(){try{setCorrectSliders(),setCorrectLazyLoad(),setCorrectFormPopup(),setCorrectFormValidity(),setCorrectIntlInputs(),setCorrectVideoPopups()}catch(e){console.error(e)}})),window.addEventListener("resize",(function(){location.reload()})),console.log={},console.error={},console.warn={};