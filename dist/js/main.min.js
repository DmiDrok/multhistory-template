...
function setCorrectSliders(){var e,t,o,i;e=document.querySelector(".welcome-slider__main"),new Swiper(e,{slidesPerView:1,grabCursor:!0,autoplay:{delay:3500,disableOnInteraction:!1},pagination:{el:".welcome-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"}}),document.querySelectorAll(".action__slider").forEach((function(e){new Swiper(e,{grabCursor:!0,parallax:!0,speed:700})})),t=document.querySelector(".heroes-slider"),new Swiper(t,{slidesPerView:1,pagination:{el:".heroes-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"},breakpoints:{660:{slidesPerView:2}}}),o=document.querySelector(".reviews-slider"),i=new Swiper(o,{spaceBetween:50,slideActiveClass:"reviews-slider__slide_active",pagination:{el:".reviews-slider__pagination",type:"bullets",clickable:!0,bulletClass:"pagination-bullet",bulletActiveClass:"pagination-bullet_active"}}),window.matchMedia("(min-width: 880px)").matches&&i.destroy()}function setCorrectLazyLoad(){new LazyLoad({threshold:450})}function setCorrectFormPopup(){var e=document.querySelectorAll(".trigger"),t=document.querySelector(".wrapper");e.forEach((function(e){e.addEventListener("click",(function(){var o=e.dataset.popupSelector,i=document.querySelector(o),r=i.querySelector(".popup__row"),n=i.querySelector("input"),s=i.querySelector("form"),l=function o(n){n.target!==r&&27!==n.keyCode||(i.classList.remove("active"),document.removeEventListener("click",o),document.documentElement.classList.remove("unscroll"),t.inert=!1,e.focus())},a=e.closest("form");a&&"true"!==a.dataset.isValid||(document.documentElement.classList.add("unscroll"),t.inert=!0,i.classList.add("active"),s&&s.addEventListener("submit",(function(e){e.preventDefault(),i.classList.remove("active")})),n&&setTimeout((function(){n.focus()}),100),document.addEventListener("click",l),document.addEventListener("keydown",l))}))}))}function setCorrectFormValidity(){var e=document.querySelectorAll("form");e.forEach((function(e){var t=e.querySelector('[type="submit"]');e.addEventListener("submit",(function(e){e.preventDefault()})),Array.from(e.children).forEach((function(o){o.addEventListener("input",(function(t){e.dataset.isValid=!1;var i=e.reportValidity();e.dataset.isValid=i,o.focus()})),o.addEventListener("keypress",(function(o){13===o.keyCode&&(o.preventDefault(),"true"===e.dataset.isValid&&t.click())}))}))}))}function setCorrectIntlInputs(){document.querySelectorAll("input[type='tel']").forEach((function(e){window.intlTelInput(e,{initialCountry:"ru",autoPlaceholder:"aggressive",customPlaceholder:function(e,t){return"например: "+e}})}))}function setCorrectVideoPopups(){for(var e=function(){var e="video-".concat(t);fsLightboxInstances[e].props.onOpen=function(){var t=fsLightboxInstances[e].elements.container.querySelector("video");t.volume=.5,t.play()}},t=1;t<6;t++)e()}if(document.addEventListener("DOMContentLoaded",(function(){try{setCorrectSliders(),setCorrectLazyLoad(),setCorrectFormPopup(),setCorrectFormValidity(),setCorrectIntlInputs(),setCorrectVideoPopups()}catch(e){console.error(e)}})),window.addEventListener("orientationchange",(function(){location.reload()})),console.log={},console.error={},console.warn={},window.matchMedia("(min-width: 1024px)").matches){gsap.registerPlugin(ScrollTrigger);const e=gsap.timeline();function animWelcome(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".welcome",start:"-15% top",scrub:!0}}});return e.to(".welcome__title_bottom",{y:80}).to(".welcome__title_top",{y:100}).to(".welcome__title_note",{opacity:.5,y:50}).to(".welcome__action",{opacity:.3,y:50}).to(".welcome-slider",{y:-20}),e}function animWhat(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".what",start:"-5% top",scrub:!0}}});return e.to(".what__title",{y:50}).to(".what__subtitle",{y:50}).to(".what__text",{y:60}).to(".what .decor-image",{x:20,y:20}),e}function animActions(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".actions",start:"-20% top",scrub:!0}}});return e.to(".actions__title",{y:50}).to(".action__slider",{y:30}),e}function animPoints(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".points",start:"-15% top",scrub:!0}}});return e.to(".points__title",{y:80}).to(".points-list .point",{y:40}).to(".points-list .point:nth-child(3n+1)",{y:20}),e}function animHeroes(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".heroes",start:"-10% top",scrub:!0}}});return e.to(".heroes__title",{y:60}).to(".heroes__subtitle",{y:10}).to(".heroes__descr-text",{y:15}).to(".heroes__action",{y:5}),e}function animVideos(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".videos",start:"-10% top",scrub:!0}}});return e.to(".videos__title",{y:50}),e}function animEvents(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".events",start:"-30% top",scrub:!0}}});return e.to(".events__title",{y:80}).to(".events__line",{y:45}).to(".motivation__title",{y:80}).to(".motivation__text",{y:0}).to(".motivation__action-wrapper",{x:-30}),e}function animReviews(){const e=gsap.timeline({defaults:{scrollTrigger:{trigger:".reviews",start:"-40% top",scrub:!0}}});return e.to(".reviews__bg_fly-1",{yPercent:-110}).to(".reviews__bg_fly-2",{yPercent:-200}).to(".reviews__bg_fly-3",{yPercent:-350}).to(".reviews__bg_fly-4",{xPercent:150}).to(".reviews__bg_fly-5",{xPercent:380}).to(".reviews__bg_fly-6",{yPercent:-30}),e}e.add(animWelcome()),e.add(animWhat()),e.add(animActions()),e.add(animPoints()),e.add(animHeroes()),e.add(animVideos()),e.add(animEvents()),e.add(animReviews())}